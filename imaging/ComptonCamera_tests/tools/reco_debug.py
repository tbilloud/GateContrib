...
def reco(cones, vsize, vpitch, source_pos):
...
if __name__ == "__main__":
    ...
    # fname, E0_MeV, world_mm = Path('../Gate9/output'), 0.140, 200
    ...
    fname, E0_MeV, world_mm = Path('../Gate10/output'), 1.0, 2000
    cones = hits2cones_withDepth_byEventID(fname / 'CC_Hits.root', E0_MeV)

    vsize = (256, 256, 256)
    vpitch = world_mm / vsize[2]
    source_pos = [vsize[0] // 2,vsize[1] // 2,vsize[2] // 2] # in units of voxels in vol

    reco(cones, vsize, vpitch, source_pos)