...
df = tree.arrays(
    # ["eventID ", 'coincID', "layerName", "time", "round(1000*energy)"],
    # "eventID == 490019",
    # "coincID == 10631",
    library='pd')
print(df[:])
...
#     print('number of coincidences with', i, 'singles:', len(coincSize[coincSize == i]),
#           '(can be in same layer, can be from different events)' if i > 1 else '(should be 0?)')
