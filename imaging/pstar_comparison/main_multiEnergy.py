...
if __name__ == "__main__":
    ...
    for idx, energy in enumerate(energies_MeV_list):
        ...
        r = histos[idx].Fit('gaus' if energy<100 else 'landau', option='S', xmin=mean * 0.1, xmax=mean * 2)
        ROOT.gPad.Update()
    ...
    legend = ROOT.TLegend(0.2, 0.7, 0.35, 0.8)
    ...
    c.SaveAs(f'thickness{int(thickness / um)}um_step{step_size / um}um_{sim.physics_manager.physics_list_name}.png')
